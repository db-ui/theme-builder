...
export const speakingNamesDefaultMapping: SpeakingName[] = [
  ...
  { name: "on-bg-basic-100-default", dark: 12, light: 3 },
  { name: "on-bg-basic-100-hovered", dark: 11, light: 4 },
  { name: "on-bg-basic-100-pressed", dark: 10, light: 5 },
  { name: "on-bg-basic-90-default", dark: 10, light: 5 },
  { name: "on-bg-basic-90-hovered", dark: 9, light: 6 },
  { name: "on-bg-basic-90-pressed", dark: 8, light: 7 },
  { name: "on-bg-basic-80-default", dark: 9, light: 6 },
  { name: "on-bg-basic-80-hovered", dark: 8, light: 5 },
  { name: "on-bg-basic-80-pressed", dark: 7, light: 4 },
  { name: "on-bg-basic-70-default", dark: 8, light: 7 },
  { name: "on-bg-basic-70-hovered", dark: 7, light: 6 },
  { name: "on-bg-basic-70-pressed", dark: 6, light: 5 },
  { name: "on-bg-basic-60-default", dark: 6, light: 10 },
  { name: "on-bg-basic-60-hovered", dark: 5, light: 9 },
  { name: "on-bg-basic-60-pressed", dark: 4, light: 8 },
  { name: "on-bg-basic-50-default", dark: 5, light: 9 },
  { name: "on-bg-basic-50-hovered", dark: 4, light: 8 },
  { name: "on-bg-basic-50-pressed", dark: 3, light: 7 },
  ...
  { name: "on-inverted-default", dark: 3, light: 14 },
  { name: "on-inverted-hovered", dark: 4, light: 13 },
  { name: "on-inverted-pressed", dark: 5, light: 12 },
];
